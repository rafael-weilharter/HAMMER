...
class decoderBlock(nn.Module):
    def __init__(self, nconvs, inchannelF, channelF, stride=(1,1,1), nstride=1, att=False):
        ...
        if att:
            self.attention = nn.Sequential(nn.Conv3d(channelF, channelF, kernel_size=3, padding=1, stride=1, bias=False),
                ...
                nn.ReLU(inplace=True),
                AttentionLayer3D(channelF, channelF, 3, 1, 1, 1, bias=False))
