...
# def scale_and_crop(scaling, img, intrinsics, depth_image=None):
#         if(scaling != 1.0):
...
class MVSDataset(Dataset):
        ...
        for scan in scans:
            ...
            with open(os.path.join(self.datapath, pair_file)) as f:
                ...
                for view_idx in range(num_viewpoint):
                    ...
                    # count = 0
                    # while len(src_views) < 25:
                    #     count += 1
                    #     neighbor_idx_pos = int(ref_view + count)
                    #     # print("neighbor pos: ", neighbor_idx_pos)
                    ...
                    #     # print("neighbor neg: ", neighbor_idx_neg)
    ...
    def read_cam_file(self, filename):
        ...
        if len(lines[11].split()) >= 3:
            ...
            return intrinsics, extrinsics, depth_min, depth_interval, self.ndepths, 0
    ...
    # def scale_and_crop_eval(self, scaling, img, intrinsics, depth_image):
    #     if(scaling != 1.0):
    ...
    #     assert color_to_depth_ratio == depth_w/new_w, "depth map does not match color image ratio"
